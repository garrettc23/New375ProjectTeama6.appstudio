...
const cacheName = '_75ProjectTeama5-2021-11-02 13:08:46.381852'; // unique value, generated each deploy
  ...
  e.waitUntil(
    caches.keys().then((keyList) => {
      ...
      return Promise.all(keyList.map((key) => {
        ...
        if (cacheName.indexOf(key) === -1  && key.substr(0, '_75ProjectTeama5'.length) === '_75ProjectTeama5') {
